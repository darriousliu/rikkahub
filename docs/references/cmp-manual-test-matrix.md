...
| M38 | 聊天消息翻译、折叠、清除与重启 | JVM | 电脑插件无法获取可操作窗口，原生测试包连接持续报屏幕采集错误 -3811 | 翻译预存 Hello；折叠/展开；重启；清除后再次重启 | 译文正常展示和恢复，清除后不重现 | Blocked | 三端代码测试 121/137/121 通过；未发真实请求；[工具错误及复测步骤](cmp-gui-regression.md#2026-09-09聊天消息翻译) | 2026-09-09 |
