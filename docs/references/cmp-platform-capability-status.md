...
Workspace 文本替换器 `TextReplacers.kt` 已整文件原样迁入 commonMain，原 14 项测试在三端通过。
Android Workspace 工具继续使用原替换调用；Rootfs、文件访问和 shell 沿用现有平台边界，
详见[验证记录](cmp-migration-progress.md#2026-09-09workspace-文本替换器)。
