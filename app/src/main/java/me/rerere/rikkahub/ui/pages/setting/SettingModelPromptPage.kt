...
internal fun PromptSettingsPage(settings: Settings, vm: SettingVM, contentPadding: PaddingValues) {
    LazyColumn(
        ...
        item {
            PromptSettingItem(
                title = stringResource(Res.string.setting_model_page_prompt_translation),
                promptDescription = stringResource(Res.string.setting_model_page_translate_prompt_vars),
        ...
        item {
            PromptSettingItem(
                title = stringResource(Res.string.setting_model_page_prompt_title),
                promptDescription = stringResource(Res.string.setting_model_page_suggestion_prompt_vars),
        ...
        item {
            PromptSettingItem(
                title = stringResource(Res.string.setting_model_page_prompt_suggestion),
                promptDescription = stringResource(Res.string.setting_model_page_suggestion_prompt_vars),
        ...
        item {
            PromptSettingItem(
                title = stringResource(Res.string.setting_model_page_prompt_ocr),
                promptDescription = stringResource(Res.string.setting_model_page_ocr_prompt_vars),
        ...
        item {
            PromptSettingItem(
                title = stringResource(Res.string.setting_model_page_prompt_compress),
                promptDescription = stringResource(Res.string.setting_model_page_compress_prompt_vars),
...
private fun PromptSettingItem(
    ...
    CardGroup(title = { Text(title) }) {
        item(
            ...
            headlineContent = { Text(stringResource(Res.string.setting_model_page_prompt)) },
            trailingContent = {
                Icon(
        ...
        if (reasoningLevel != null && onUpdateReasoningLevel != null) {
            item(
                headlineContent = { Text(stringResource(Res.string.assistant_page_thinking_budget)) },
                trailingContent = {
                    ReasoningButton(
