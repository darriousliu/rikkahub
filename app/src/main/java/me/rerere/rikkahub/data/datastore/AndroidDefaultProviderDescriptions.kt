...
internal val ANDROID_DEFAULT_PROVIDER_DESCRIPTIONS = mapOf<Uuid, @Composable () -> Unit>(
    Uuid.parse("56a94d29-c88b-41c5-8e09-38a7612d6cf8") to {
        MarkdownBlock(
            content = """
    ...
    Uuid.parse("da020a90-f7b3-4c29-b90e-c511a0630630") to {
        MarkdownBlock(
            content = """
