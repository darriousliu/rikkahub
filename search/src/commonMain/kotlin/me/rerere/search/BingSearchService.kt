...
object BingSearchService : SearchService<SearchServiceOptions.BingLocalOptions> {
    ...
    override suspend fun search(
        ...
        val acceptLanguage = currentSearchLocale().toAcceptLanguageHeader()
...
internal data class SearchLocale(
    val language: String,
    val country: String,
)

internal fun SearchLocale.toAcceptLanguageHeader(): String =
    if (country.isBlank()) language else "$language-$country,$language"

internal expect fun currentSearchLocale(): SearchLocale
