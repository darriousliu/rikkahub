...
fun SiliconFlowPowerByIcon(modifier: Modifier = Modifier) {
    ...
    if (!darkMode) {
        AsyncImage(model = Res.drawable.siliconflow_light, contentDescription = null, modifier = modifier)
    } else {
        AsyncImage(model = Res.drawable.siliconflow_dark, contentDescription = null, modifier = modifier)
    }
}
