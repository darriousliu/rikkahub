package me.rerere.rikkahub.ui.pages.safemode
...
fun SafeModePage(
    ...
    val preferences = koinInject<StringPreferenceStore>()
            ...
            if (stackTrace != null) {
                Row(
                    ...
                    OutlinedButton(
                        onClick = {
                            scope.launch {
                                clipboard.setClipEntry(createPlainTextClipEntry("crash", stackTrace))
                            }
                        }
                    ) {
        ...
        AssistantPickerSheet(
            ...
            onAssistantSelected = { assistantId ->
                ...
                scope.launch(start = CoroutineStart.UNDISPATCHED) {
                    preferences.set("lastConversationId", null)
                }
