...
//            }
            ...
            stickyHeader {
                Text(
                    text = stringResource(Res.string.setting_page_message_display_settings),
                    style = MaterialTheme.typography.titleSmall,
                    color = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                )
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_show_assistant_bubble_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_show_assistant_bubble_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            stickyHeader {
                Text(
                    text = stringResource(Res.string.setting_page_code_display_settings),
                    style = MaterialTheme.typography.titleSmall,
                    color = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                )
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_show_line_numbers_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_show_line_numbers_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            stickyHeader {
                Text(
                    text = stringResource(Res.string.setting_page_interaction_notification_settings),
                    style = MaterialTheme.typography.titleSmall,
                    color = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                )
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_send_on_enter_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_send_on_enter_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            if (displaySetting.showMessageJumper) {
                item {
                    ListItem(
                        colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                        headlineContent = {
                            Text(stringResource(Res.string.setting_display_page_message_jumper_position_title))
                        },
                        supportingContent = {
                            Text(stringResource(Res.string.setting_display_page_message_jumper_position_desc))
                        },
                        trailingContent = {
                            Switch(
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_enable_auto_scroll_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_enable_auto_scroll_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_paste_long_text_as_file_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_paste_long_text_as_file_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            if (displaySetting.pasteLongTextAsFile) {
                item {
                    ListItem(
                        headlineContent = {
                            Text(stringResource(Res.string.setting_display_page_paste_long_text_threshold_title))
                        },
                        colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    )
                    Row(
            ...
            stickyHeader {
                Text(
                    text = stringResource(Res.string.setting_page_tts_settings),
                    style = MaterialTheme.typography.titleSmall,
                    color = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp),
                )
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_tts_only_read_quoted_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_tts_only_read_quoted_desc))
                    },
                    trailingContent = {
                        Switch(
            ...
            item {
                ListItem(
                    colors = ListItemDefaults.colors(containerColor = Color.Transparent),
                    headlineContent = {
                        Text(stringResource(Res.string.setting_display_page_auto_play_tts_title))
                    },
                    supportingContent = {
                        Text(stringResource(Res.string.setting_display_page_auto_play_tts_desc))
                    },
                    trailingContent = {
                        Switch(
