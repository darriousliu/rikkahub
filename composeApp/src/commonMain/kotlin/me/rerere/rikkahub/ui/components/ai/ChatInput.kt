        ...
        Surface(
            ...
            Column {
                ...
                val receiveContentListener = remember {
                    createImageReceiveListener(state = state, context = context)
                }
                TextField(
        ...
        ListItem(
            leadingContent = {
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.chat_page_learning_mode),
                )
            },
            headlineContent = {
                Text(stringResource(Res.string.chat_page_learning_mode))
            },
            supportingContent = {
                Text(stringResource(Res.string.chat_page_learning_mode_desc))
            },
            trailingContent = {
                Switch(
