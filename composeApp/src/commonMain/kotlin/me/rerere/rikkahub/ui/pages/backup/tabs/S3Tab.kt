...
import rikkahub.composeapp.generated.resources.backup_page_s3_access_key_id
import rikkahub.composeapp.generated.resources.backup_page_s3_backup_files
import rikkahub.composeapp.generated.resources.backup_page_s3_bucket
import rikkahub.composeapp.generated.resources.backup_page_s3_endpoint
import rikkahub.composeapp.generated.resources.backup_page_s3_region
import rikkahub.composeapp.generated.resources.backup_page_s3_secret_access_key
    ...
    Column(
        ...
        OutlinedCard {
            Column(
                ...
                FormItem(
                    label = { Text(stringResource(Res.string.backup_page_s3_endpoint)) }
                ) {
                    OutlinedTextField(
                ...
                FormItem(
                    label = { Text(stringResource(Res.string.backup_page_s3_access_key_id)) }
                ) {
                    OutlinedTextField(
                        modifier = Modifier.fillMaxWidth(),
                ...
                FormItem(
                    label = { Text(stringResource(Res.string.backup_page_s3_secret_access_key)) }
                ) {
                ...
                FormItem(
                    label = { Text(stringResource(Res.string.backup_page_s3_bucket)) }
                ) {
                    OutlinedTextField(
                        modifier = Modifier.fillMaxWidth(),
                ...
                FormItem(
                    label = { Text(stringResource(Res.string.backup_page_s3_region)) }
                ) {
                    OutlinedTextField(
                        modifier = Modifier.fillMaxWidth(),
                ...
                MultiChoiceSegmentedButtonRow(
                    ...
                    S3Config.BackupItem.entries.forEachIndexed { index, item ->
                        SegmentedButton(
                            ...
                            Text(
                                when (item) {
                                    S3Config.BackupItem.DATABASE -> stringResource(Res.string.backup_page_chat_records)
                                    S3Config.BackupItem.FILES -> stringResource(Res.string.backup_page_files)
                                }
                            )
                        }
                    }
    ...
    if (showBackupFiles) {
        ModalBottomSheet(
            ...
            Column(
                ...
                Text(
                    stringResource(Res.string.backup_page_s3_backup_files),
                    modifier = Modifier.fillMaxWidth()
                )
