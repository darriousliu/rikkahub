        ...
        backgroundContent = {
            Row(
                ...
                FilledIconButton(onClick = {
                    ...
                    Icon(Lucide.Trash2, stringResource(Res.string.prompt_page_delete))
                }
            }
        },
        ...
        Card(
            ...
            Row(
                ...
                IconButton(onClick = { showExportDialog = true }) {
                    Icon(Lucide.Share2, stringResource(Res.string.export_title))
                }
                IconButton(onClick = onEdit) {
                    Icon(Lucide.Settings2, stringResource(Res.string.prompt_page_edit))
                }
            }
        }
    }
            ...
            Column(
                ...
                Row(
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(Lucide.Plus, stringResource(Res.string.prompt_page_add_entry))
                    }
                }
        ...
        Row(
            ...
            Column(
                ...
                if (entry.keywords.isNotEmpty()) {
                    Text(
                        text = stringResource(
                            Res.string.prompt_page_keywords_format,
            ...
            Column(
                ...
                Row(
                    ...
                    IconButton(
                        ...
                        Icon(Lucide.Plus, stringResource(Res.string.prompt_page_add))
                    }
                }
