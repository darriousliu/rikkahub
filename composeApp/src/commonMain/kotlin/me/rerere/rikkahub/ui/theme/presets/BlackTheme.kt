...
import rikkahub.composeapp.generated.resources.theme_name_black

val BlackThemePreset by lazy {
    PresetTheme(
        id = "black",
        name = {
            Text(stringResource(Res.string.theme_name_black))
        },
...
private val primaryLight = Color(0xFF343434)
private val onPrimaryLight = Color(0xFFFCFCFC)
private val primaryContainerLight = Color(0xFF444444)
private val onPrimaryContainerLight = Color(0xFFB5B5B5)
private val secondaryLight = Color(0xFF8E8E8E)
private val onSecondaryLight = Color(0xFFFCFCFC)
private val secondaryContainerLight = Color(0xFFF7F7F7)
private val onSecondaryContainerLight = Color(0xFF343434)
...
private val inverseOnSurfaceLight = Color(0xFFFCFCFC)
...
private val backgroundDark = Color(0xFF252525)
