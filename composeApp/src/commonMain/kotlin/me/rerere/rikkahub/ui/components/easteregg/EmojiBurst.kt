...
import me.rerere.rikkahub.utils.toRadians
                ...
                if (pendingBursts.isNotEmpty()) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        repeat(spawnCount) {
                            ...
                            val jitterAngle = Random.nextDouble(0.0, 360.0).toRadians().toFloat()
                            ...
                            val angleRad = Random.nextDouble(220.0, 320.0).toRadians().toFloat()
