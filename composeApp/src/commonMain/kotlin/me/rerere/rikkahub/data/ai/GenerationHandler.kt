...
import me.rerere.rikkahub.utils.getDisplayLanguageInEnglish
        ...
        for (stepIndex in 0 until maxSteps) {
            ...
            if (pendingTools.isEmpty()) {
                ...
                if (hasPendingApproval) {
                    Logger.i(TAG) { "generateText: waiting for tool approval" }
                    break
                }
                ...
                Logger.i(TAG) { "generateText: resuming with ${pendingTools.size} approved/denied tools" }
                ...
                when (tool.approvalState) {
                    ...
                    is ToolApprovalState.Pending -> {
                        ...
                        runCatching {
                            ...
                            Logger.i(TAG) { "generateText: executing tool ${toolDef.name} with args: $args" }
                    ...
                    customBody = listOf(
                        CustomBody(
                            ...
                            value = buildJsonObject {
                                ...
                                put(
                                    "target_lang",
                                    JsonPrimitive(targetLanguage.getDisplayLanguageInEnglish())
                                )
                            }
                        )
                    )
