...
interface MessageNodeDAO {
    ...
    @RawQuery
    suspend fun getTokenStatsRaw(query: RoomRawQuery): MessageTokenStats

    @RawQuery
    suspend fun getMessageCountPerDayRaw(query: RoomRawQuery): List<MessageDayCount>
}
...
private val TOKEN_STATS_SQL = RoomRawQuery(
...
suspend fun MessageNodeDAO.getMessageCountPerDay(startDate: String): List<MessageDayCount> =
    getMessageCountPerDayRaw(
        RoomRawQuery(
            ...
            statement.bindText(1, startDate)
        }
    )
