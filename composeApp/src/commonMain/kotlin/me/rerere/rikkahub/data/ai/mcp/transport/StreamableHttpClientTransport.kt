...
public class StreamableHttpClientTransport(
    ...
    override suspend fun start() {
        ...
        Logger.d(TAG) { "Client transport starting..." }
    }
    ...
    suspend fun send(
        ...
        Logger.d(TAG) { "Client sending message via POST to $url: ${McpJson.encodeToString(message)}" }
    ...
    override suspend fun close() {
        ...
        Logger.d(TAG) { "Client transport closing." }
    ...
    private suspend fun handleInlineSse(
        ...
        Logger.d(TAG) { "Handling inline SSE from POST response" }
