...
actual fun PlatformContext.readStringPreference(key: String, defaultValue: String?): String? {
...
actual fun PlatformContext.readBooleanPreference(key: String, defaultValue: Boolean): Boolean {
    return getSharedPreferences("rikkahub.preferences", Context.MODE_PRIVATE).getBoolean(key, defaultValue)
}

private fun SharedPreferences.getStringFlowForKey(keyForString: String, defaultValue: String? = null) =
    callbackFlow {
...
private fun SharedPreferences.getBooleanFlowForKey(keyForBoolean: String, defaultValue: Boolean = false) =
    callbackFlow {
        val listener = SharedPreferences.OnSharedPreferenceChangeListener { _, key ->
