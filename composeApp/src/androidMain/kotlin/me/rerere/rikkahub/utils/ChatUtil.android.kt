...
fun PlatformContext.createChatFilesByContents(uris: List<android.net.Uri>): List<android.net.Uri> {
...
fun PlatformContext.getFileNameFromUri(uri: android.net.Uri): String? {
...
fun PlatformContext.getFileMimeType(uri: android.net.Uri): String? {
...
fun PlatformContext.deleteChatFiles(uris: List<android.net.Uri>) {
